...
/**
 * This ViewModel holds all Ad related data, communicates Fragment
 * This one ViewModel shares data between two fragments AdDetailsFragment and AdFragment
 *
...
class AdViewModel(private val adListGetUseCase: AdListGetUseCase) : ViewModel() {
    ...
    fun itemClicked(item: Ad, position: Int) {
        ...
        if (_selectedItemLiveData.value != null ) {
            ...
            val previousSelectedData = _listOfAdsLiveData.value?.get(_selectedItemLiveData.value!!)
